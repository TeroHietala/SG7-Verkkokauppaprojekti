...
export default function Navbar({ url, cart, icon, steps }) {
  ...
  const login = customers.map((customer) => (
    ...
    <p classNameName="nav-text">Tervetuloa {customer.first_name}
      <Link className="bi bi-box-arrow-right" type="button" onClick={e => emptyUser()}>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-door-open-fill" viewBox="0 0 20 20">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" id="tuotteet" aria-labelledby="navbarDropdown">
          ...
          <ul className="navbar-nav ml-auto">
            <li className="nav-item dropdown dropstart">
              <a className="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="false" >
              ...
              <ul className="dropdown-menu" id="chatbot" aria-labelledby="navbarDropdownClickable">
              <Chatbot 
              steps={steps} />
              </ul>
            </li>
          ...
          <ul className="navbar-nav ml-auto">
            <li className="nav-item dropdown dropstart">
              ...
              <ul className="dropdown-menu" id="login" aria-labelledby="navbarDropdown">
                <li >
                  <p>Kirjaudu</p>
